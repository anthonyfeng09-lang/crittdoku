...
export const ROSTER: Record<CreatureId, CreatureDef> = {
  ...
  mudpaw: {
    ...
    epithet: "Planted",
    category: "anchor",
    blurb: "When play freezes, tied regions where you hold one of its cells settle in your favour.",
  ...
  slatetusk: {
    ...
    epithet: "Bedrock",
    category: "anchor",
    blurb: "Its cells are permanent, and it stores 1 energy when placed.",
    permanent: true,
    energyBonus: 1,
  },
  lichenox: {
    ...
    epithet: "Slow spread",
    category: "anchor",
    blurb: "Sleeps a turn as it takes hold, then each of its cells counts double toward holding a region.",
    dormant: true,
    territoryWeight: 2,
  },
  ...
  driftmink: {
    ...
    epithet: "Skimming",
    category: "drift",
    blurb: "Its cells can hop, and it stores 2 energy on placement.",
    moveAdjacent: true,
    energyBonus: 2,
  },
  galepup: {
    ...
    epithet: "Gusting",
    category: "drift",
    blurb: "Its cells can hop, diagonally too, and it stores 1 energy on placement.",
    moveAdjacent: true,
    moveDiagonal: true,
    energyBonus: 1,
  },
  dandypuff: {
    ...
    epithet: "Weightless",
    category: "drift",
    blurb: "Its cells can hop, and any removal only sends it away for a turn instead of taking it.",
    moveAdjacent: true,
  ...
  drowsivole: {
    ...
    epithet: "Half-asleep",
    category: "hush",
    blurb: "Sleeps a turn, then wakes and locks any of its regions you are leading. Once awake, gains 3 energy whenever the opponent locks a region it sits in.",
    dormant: true,
    claimRegionsOnWake: true,
  ...
  lullabird: {
    ...
    epithet: "Soft song",
    category: "hush",
    blurb: "Sleeps a turn, then wakes and locks any of its regions you are leading. At the freeze, tied regions it sits in settle in your favour.",
    dormant: true,
    claimRegionsOnWake: true,
    breakTiesToOwner: true,
  },
  dreamnewt: {
    id: "dreamnewt",
    name: "Dreamnewt",
    epithet: "Drifting off",
    category: "hush",
    blurb: "Stores 2 energy, sleeps two turns, then wakes and locks any of its regions you are leading. A slow, heavy pounce.",
    dormant: true,
    dormantTurns: 2,
    energyBonus: 2,
    claimRegionsOnWake: true,
  ...
  sunmoth: {
    ...
    epithet: "Basking",
    category: "thrift",
    blurb: "Stores 3 energy when placed.",
    energyBonus: 3,
  },
  emberfinch: {
    id: "emberfinch",
    ...
    epithet: "Kindling",
    category: "thrift",
    blurb: "Stores 2 energy, and 3 more each time the opponent locks a region it sits in.",
    energyBonus: 2,
    energyOnOpponentLock: true,
  },
  ...
  barkmole: {
    ...
    epithet: "Bunkered",
    category: "ward",
    blurb: "The opponent can't lock a region by completing it while you hold a cell there, and any removal only sends it away for a turn.",
    denyOpponentLock: true,
    regrowIfRemoved: true,
  },
  ...
  joltjay: {
    ...
    epithet: "Twitchy",
    category: "snap",
    blurb: "When you place this digit you may pay energy to place a second digit the same turn, and it stores 1 energy on placement.",
    canBurst: true,
    energyBonus: 1,
  },
  sparkpaw: {
    ...
    epithet: "Static",
    category: "snap",
    blurb: "Pay energy to place this digit ignoring the row, column and box rule, or to place it onto an opponent's non-permanent digit in a contested region, removing it.",
    canWild: true,
    canMole: true,
  },
};
